                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      BottomItem(
                        isSelected:
                            _controller.selectedIndex == 0 ? true : false,
                        onTap: () => _controller.updateTabSelection(0),
                        svgPath: 'assets/svg/home.svg',
                      ),
                      BottomItem(
                        isSelected:
                            _controller.selectedIndex == 1 ? true : false,
                      ...
                      BottomItem(
                        isSelected:
                            _controller.selectedIndex == 2 ? true : false,
                        onTap: () => _controller.updateTabSelection(2),
                        svgPath: 'assets/svg/cart.svg',
                      ),
                      BottomItem(
                        isSelected:
                            _controller.selectedIndex == 3 ? true : false,
